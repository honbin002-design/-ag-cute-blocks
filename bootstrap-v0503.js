...
import './mobile-viewport-lock-runtime.js?v=0.5.03';
...
import './building-extension-runtime.js?v=0.5.03';
import './character-polish-runtime.js';
// V0.5.03 keeps first-load-safe persistent asset caching before any GLB character-part fetch begins.
import './asset-fetch-resilience-runtime.js?v=0.5.03';
import './character-asset-runtime-v0499.js';
import './character-motion-fix-runtime.js?v=0.5.03';
import './pet-grounding-runtime.js';

// Mobile control presentation attaches after the HUD exists, before input handlers.
import './mobile-controls-runtime.js?v=0.5.03';
import './aim-reticle-runtime.js?v=0.5.03';
import './movement-mode-persistence-runtime.js?v=0.5.03';

// Input and life extensions attach after the main HUD/world handlers exist.
import './mobile-input-runtime.js?v=0.5.03';
...
globalThis.__AGCB_BOOTSTRAP={version:'0.5.03',loaded:true};