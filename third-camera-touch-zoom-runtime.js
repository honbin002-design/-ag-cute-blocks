// AG Cute Blocks V0.5.73 — iPhone document-level third-person pinch bridge.
// Safari can split two touches across canvas/HUD layers. Convert a background
// two-finger pinch into the core's already-guarded third-person wheel zoom path.
...
document.addEventListener('touchmove',e=>{
  ...
  // One ordinary ~100px finger spread changes camera distance by ~3.8 units,
  // enough to reach the ultra-close range from the normal 3.8 default.
...
globalThis.__AGCB_THIRD_TOUCH_ZOOM={version:'0.5.73',documentLevel:true,bridge:'touch-to-core-wheel',sensitivity:3.8,controlsExcluded:true};