...
export function isWateredToday(care,worldDay,weather='sunny'){return weather==='rain'||care.wateredDay===worldDay}
...
export function dailyCropGrowth(kind,care,worldDay,weather='sunny',seasonAllowed=true){
  ...
  if(weather==='rain')return r.base+r.rainBonus;if(care.wateredDay===worldDay)return r.base+r.waterBonus;return r.base;
}
export function cropCareLabel(care,worldDay,weather='sunny'){
  if(weather==='rain')return '🌧️ 雨水已澆灌';if(care.wateredDay===worldDay)return '💧 今天澆過水';return '🪴 可澆水加速成長';
}
