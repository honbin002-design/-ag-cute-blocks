...
import './mobile-viewport-lock-runtime.js?v=0.4.91';
...
import './building-extension-runtime.js?v=0.4.91';
import './character-polish-runtime.js';
// V0.4.91 keeps first-load-safe persistent asset caching before any GLB character-part fetch begins.
import './asset-fetch-resilience-runtime.js?v=0.4.91';
import './character-asset-runtime.js?v=0.4.91';
import './character-motion-fix-runtime.js?v=0.4.91';
import './pet-grounding-runtime.js';

// Mobile control presentation attaches after the HUD exists, before input handlers.
import './mobile-controls-runtime.js?v=0.4.91';
import './aim-reticle-runtime.js?v=0.4.91';
import './movement-mode-persistence-runtime.js?v=0.4.91';

// Input and life extensions attach after the main HUD/world handlers exist.
import './mobile-input-runtime.js?v=0.4.91';
import './animal-life-runtime.js';
import './crop-care-runtime.js';
import './orchard-runtime.js';
import './furniture-life-details.js';
import './sleep-routine.js?v=0.4.91';
import './wildlife-live-runtime.js';
import './weather-visual-runtime.js';

globalThis.__AGCB_BOOTSTRAP={version:'0.4.91',loaded:true};
