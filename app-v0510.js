...
// V0.5.97 keeps bootstrap as the single version owner and adds conflict-safe build-only undo/redo.
import './tree-resource-integrity-preload-v0588.js';
import './terrain-artificial-water-preload-v0592.js';
import './release-version-v0597.js';
import './app-v0504-fixed-loader.js';
globalThis.__AGCB_RELEASE_OVERLAY={base:'0.5.04',additive:true,recovery:'v0504-tdz-fixed-loader+v0588-tree-resource-preload+v0592-connected-artificial-water+v0597-finite-reload-version-convergence+catalog-search+catalog-recent-favorites+conflict-safe-build-undo-redo',rollbackBase:'0.5.03',versionOwner:'bootstrap-v0510.js',runtimeVersion:'0.5.97',legacyVersionWriteDisabled:true};