...
globalThis.__AGCB_BOOTSTRAP={version:'0.5.15',loaded:true,baseWorld:'0.5.03',optional:{},testCharacterRuntime:'pending',recovery:'v0504-tdz-bypass',target:'mockup-ui-character-v2'};
...
const optional=[
 ...
 './mobile-controls-runtime.js?v=0.5.15','./ui-compact-v0515-runtime.js?v=mockup2','./aim-reticle-runtime.js?v=0.5.15','./movement-mode-persistence-runtime.js?v=0.5.15',
...
setTimeout(async()=>{
 try{
  await import('./test-character-game-runtime.js?v=0.5.15-target2');
  await import('./test-character-game-integration.js?v=0.5.15-target2');
