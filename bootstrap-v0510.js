// AG Cute Blocks V0.5.17 resilient bootstrap over recovered V0.5.03 world core.
// Only the base world is startup-critical. Additive runtimes load independently and fail-open.
import './app-v0510.js';

const release='V0.5.17';
...
globalThis.__AGCB_BOOTSTRAP={version:'0.5.17',loaded:true,baseWorld:'0.5.03',optional:{},testCharacterRuntime:'pending',recovery:'v0504-tdz-bypass',target:'cat-ear-v9-front-crown-correct-face'};

const optional=[
 './render-performance-runtime.js','./collision-cache-runtime.js','./raycast-budget-runtime.js',
 './mobile-viewport-lock-runtime.js?v=0.5.17','./ag-original-character-runtime.js','./ag-original-animal-runtime.js',
 './heading-runtime.js','./furniture-safety-runtime.js','./procedural-material-runtime.js',
 './building-extension-runtime.js?v=0.5.17','./character-polish-runtime.js','./asset-fetch-resilience-runtime.js?v=0.5.17',
 './character-asset-runtime-v0499.js','./character-motion-fix-runtime.js?v=0.5.17','./pet-grounding-runtime.js',
 './mobile-controls-runtime.js?v=0.5.17','./ui-compact-v0515-runtime.js?v=scroll-v2','./aim-reticle-runtime.js?v=0.5.17','./movement-mode-persistence-runtime.js?v=0.5.17',
 './mobile-input-runtime.js?v=0.5.17','./animal-life-runtime.js','./crop-care-runtime.js','./orchard-runtime.js',
 './furniture-life-details.js','./sleep-routine-v0499.js','./wildlife-live-runtime.js','./weather-visual-runtime.js',
 './fishing-ecology-runtime-v0505.js?v=0.5.17','./fishing-forecast-runtime-v0506.js?v=0.5.17','./fishing-journal-runtime-v0510.js?v=0.5.17',
...
setTimeout(async()=>{
 try{
  await import('./test-character-game-runtime.js?v=0.5.17-accessories-v7');
  await import('./test-character-game-integration.js?v=0.5.17-target4');
