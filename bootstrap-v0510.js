...
globalThis.__AGCB_BOOTSTRAP={version:'0.5.15',loaded:true,baseWorld:'0.5.03',optional:{},testCharacterRuntime:'pending',recovery:'v0504-tdz-bypass',target:'cat-ear-fit-plus-collapsible-catalog'};
...
const optional=[
 ...
 './mobile-controls-runtime.js?v=0.5.15','./ui-compact-v0515-runtime.js?v=collapsible-v1','./aim-reticle-runtime.js?v=0.5.15','./movement-mode-persistence-runtime.js?v=0.5.15',
 ...
 './cat-ear-fit-runtime.js?v=earfit-v1'
];
...
setTimeout(async()=>{
 try{
  await import('./test-character-game-runtime.js?v=0.5.15-accessories-v6');
