...
export function normalizeAvatarCustomization(input={},legacyStyle='girl'){
  ...
  const role=['special','special2','special3','special5'].includes(src.role)?src.role:'standard';const gender=src.gender==='boy'||src.gender==='girl'?src.gender:legacyStyle==='boy'?'boy':'girl';
