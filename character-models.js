...
export const DEFAULT_AVATAR_CUSTOMIZATION={schema:3,appearanceRevision:4,gender:'girl',role:'standard',age:'child',body:'round',skin:'light',hairStyle:'ponytail',hair:'chestnut',outfit:'dress',top:'pink',bottom:'denim',hat:'none',glasses:'none',accessory:'none'};
