...
export function createCuteChildAvatar(style='girl',options={}){
  ...
  if(original){original.userData={...original.userData,avatarStyle:c.gender,avatarCustomization:c,avatarVisualStyle:'ag-original-connected-v2',pose:'idle'};LIVE_AVATARS.add(original);globalThis.__AGCB_UPGRADE_AVATAR?.(original,c);globalThis.AGCBCharacterPose=pose=>setCuteCharacterPose(original,pose);return original;}
...
export const DEFAULT_AVATAR_CUSTOMIZATION={schema:3,appearanceRevision:4,gender:'girl',age:'child',body:'round',skin:'light',hairStyle:'ponytail',hair:'chestnut',outfit:'dress',top:'pink',bottom:'denim',hat:'none',glasses:'none',accessory:'none'};
