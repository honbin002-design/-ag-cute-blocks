...
export function createCow(){
  const g=new THREE.Group(),hide=M(0xf1eee7),dark=M(0x4f4743),pink=M(0xe7aaa9),body=ell(g,.43,0,.73,.10,hide,[1.62,.88,.90],24),neck=ell(g,.29,0,.77,-.42,hide,[.90,1.20,.82],20),headPivot=new THREE.Group();headPivot.position.set(0,.83,-.70);g.add(headPivot);
  ...
  const legs=[leg(g,-.28,-.16,hide,.58),leg(g,.28,-.16,hide,.58),leg(g,-.30,.36,hide,.58),leg(g,.30,.36,hide,.58)];for(const x of[-.22,.22]){const ear=ell(headPivot,.105,x,.10,.03,dark,[1.35,.48,.70],14);ear.rotation.z=x<0?-.20:.20;cone(headPivot,.042,.20,x*.72,.25,.08,0xe1d0a4,[0,0,x<0?.58:-.58])}for(const x of[-.105,.105])eye(headPivot,x,.04,-.24);
  ...
  g.userData={animalType:'cow',legs,tail,headPivot,body,neck,phase:Math.random()*6.28,...baseState('cow',.83,.73)};return register(g);
}
export function createSheep(){
  const g=new THREE.Group(),wool=M(0xf0eee7),face=M(0x625b56),hoof=0x493f3b,body=ell(g,.39,0,.62,.08,wool,[1.52,.94,.92],22);for(const [x,y,z,s] of [[-.34,.72,.04,.20],[.34,.72,.04,.20],[-.18,.83,.20,.19],[.18,.83,.20,.19],[0,.84,-.10,.20],[-.30,.58,.25,.18],[.30,.58,.25,.18]])ell(g,s,x,y,z,wool,[1.1,.82,1],14);
...
export function createChicken(){
  ...
  g.userData={animalType:'chicken',legs,wings:[wl,wr],headPivot,body,phase:Math.random()*6.28,...baseState('chicken',.65,.39)};return register(g);
}
